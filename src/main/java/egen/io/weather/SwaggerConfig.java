...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact("SRI.KARANAM", "https://egen.io", "sri_knm@yahoo.com");
		ApiInfo info = new ApiInfo("WEATHER REPORT", "Know Your City", "3.4.0", "Licenced By EGEN.IO", contact, "MIT",
